...
```
PLC_SRC_CONTROLLER=https://github.com/exemt/placitum-controller.git#master
```

Every component comes from its `master` branch. Once releases exist, a tag such as `#v1.2.0` can be
used instead of a branch, and this one file then pins the version of the whole installation.
