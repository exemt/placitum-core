...
Right now every component comes from its `develop` branch, that is, current development. Once
releases exist, a tag such as `#v1.2.0` can be used instead of a branch, and this one file then pins
the version of the whole installation.
